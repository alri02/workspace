...
namespace vizkit3d
{
    class AxesNode
    {
        public:
            ...
            /**
             * Returns the Text3d for the axes labels
             */
            //static osgText::Text3D* getLabelText3D(::osg::Node* axes);

           static void setLabelText3D(::osg::Node* axes,QString font);
           //static void applyFont( osgText::Text3D *text,osg::ref_ptr<osgText::Font3D> font_d);

           static osg::ref_ptr<osgText::Font3D>  getUserFont(const std::string& fontPreference);
             // holds the font
