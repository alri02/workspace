...
namespace vizkit3d
{
    ...
    class Vizkit3DConfig :public QObject
    {
        ...
        private:
            ...
            Q_PROPERTY( QStringList font READ getFont WRITE setFont)                                 
        ...
        public slots:
            ...
            QStringList getFont()const;                                                   
            void setFont(QStringList font);
    ...
    class QDESIGNER_WIDGET_EXPORT Vizkit3DWidget : public QMainWindow
    {
        ...
        public slots:
            ...
            CAMERA_MANIPULATORS getCameraManipulator() const;  
             ...
             QStringList SytemFontsAvailable() const;
        ...
        private:
            ...
            //font_available={"Ubuntu","DejaVuSerif", "FreeSans", "FreeMono" ,"FreeSerif","GentiumAlt-R"};
