...
#ifndef __OROGEN_GENERATED_TRANSFORMER_CORBA_PLUGIN_HPP
#define __OROGEN_GENERATED_TRANSFORMER_CORBA_PLUGIN_HPP

#include <rtt/types/TransportPlugin.hpp>

namespace orogen_typekits {
    class transformerCorbaTransportPlugin
    ...
    extern transformerCorbaTransportPlugin transformerCorbaTransport;
}
