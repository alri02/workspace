...
#ifndef __OROGEN_GENERATED_TRANSFORMER_TYPELIB_PLUGIN_HPP
#define __OROGEN_GENERATED_TRANSFORMER_TYPELIB_PLUGIN_HPP
...
namespace orogen_typekits {
    class transformerTypelibTransportPlugin
        : public orogen_transports::TypelibTransportPlugin
    {
    public:
        transformerTypelibTransportPlugin();
    ...
    extern transformerTypelibTransportPlugin transformerTypelibTransport;
}
