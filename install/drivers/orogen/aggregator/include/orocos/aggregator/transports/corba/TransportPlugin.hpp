...
#ifndef __OROGEN_GENERATED_AGGREGATOR_CORBA_PLUGIN_HPP
#define __OROGEN_GENERATED_AGGREGATOR_CORBA_PLUGIN_HPP

#include <rtt/types/TransportPlugin.hpp>

namespace orogen_typekits {
    class aggregatorCorbaTransportPlugin
    ...
    extern aggregatorCorbaTransportPlugin aggregatorCorbaTransport;
}
