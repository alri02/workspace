...
#ifndef __OROGEN_GENERATED_AGGREGATOR_TYPELIB_PLUGIN_HPP
#define __OROGEN_GENERATED_AGGREGATOR_TYPELIB_PLUGIN_HPP
...
namespace orogen_typekits {
    class aggregatorTypelibTransportPlugin
        : public orogen_transports::TypelibTransportPlugin
    {
    public:
        aggregatorTypelibTransportPlugin();
    ...
    extern aggregatorTypelibTransportPlugin aggregatorTypelibTransport;
}
