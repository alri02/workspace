...
#ifndef __OROGEN_GENERATED_BASE_TYPELIB_PLUGIN_HPP
#define __OROGEN_GENERATED_BASE_TYPELIB_PLUGIN_HPP
...
namespace orogen_typekits {
    class baseTypelibTransportPlugin
        : public orogen_transports::TypelibTransportPlugin
    {
    public:
        baseTypelibTransportPlugin();
    ...
    extern baseTypelibTransportPlugin baseTypelibTransport;
}
