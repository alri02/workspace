...
#ifndef __OROGEN_GENERATED_STD_TYPES_DEPRECATED_HPP
#define __OROGEN_GENERATED_STD_TYPES_DEPRECATED_HPP

#warning including std/Types.hpp directly is deprecated \
         You should include the headers that define your types directly. \
         typekit/Opaques.hpp should include std/typekit/OpaqueFwd.hpp and \
         typekit/Opaques.cpp should include std/typekit/OpaqueTypes.hpp. \
         (in doubt, see the files in templates/typekit for both of these) \
         Finally, if you are reall really sure, you can still include \
         std/typekit/Types.hpp \
