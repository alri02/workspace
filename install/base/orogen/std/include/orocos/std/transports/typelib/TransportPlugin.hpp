...
#ifndef __OROGEN_GENERATED_STD_TYPELIB_PLUGIN_HPP
#define __OROGEN_GENERATED_STD_TYPELIB_PLUGIN_HPP
...
namespace orogen_typekits {
    class stdTypelibTransportPlugin
        : public orogen_transports::TypelibTransportPlugin
    {
    public:
        stdTypelibTransportPlugin();
    ...
    extern stdTypelibTransportPlugin stdTypelibTransport;
}
